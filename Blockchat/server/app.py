import requests
import os
from flask import Flask, request, jsonify, after_this_request, g
...
from models.init_utils import init_bootstrap
...
def home():
    global NODE_ID
    return "Server of Node " + NODE_ID + " is up and running"
